...
with st.container():
    ...
    with col_kpi:
        ...
        st.markdown("<h4 style='text-align:center; color:#1E3A8A; margin-bottom:-10px; margin-top:-5px;'>🏆 OEE: EFECTIVIDAD GENERAL</h4>", unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div style='display:flex; justify-content:space-around; background:white; padding:10px; border-radius:6px; border: 1px solid #aaa; margin-bottom: 15px; text-align:center; box-shadow: 2px 4px 10px rgba(0,0,0,0.1);'>
            <div><span style='font-size:11px; color:#555; font-weight:bold;'>Disponibilidad</span><br><b style='color:#1E3A8A; font-size:16px;'>{min(disponibilidad, 100):.1f}%</b><br><span style='font-size:9px; color:#888;'>(HH Disp - Imp)/Disp</span></div>
            <div><span style='font-size:11px; color:#555; font-weight:bold;'>Rendimiento</span><br><b style='color:#1E3A8A; font-size:16px;'>{min(rendimiento, 100):.1f}%</b><br><span style='font-size:9px; color:#888;'>HH Std / HH Prod</span></div>
            <div><span style='font-size:11px; color:#555; font-weight:bold;'>Calidad</span><br><b style='color:#1E3A8A; font-size:16px;'>{calidad_sim:.1f}%</b><br><span style='font-size:9px; color:red;'>(SIMULADO)</span></div>
        </div>
        """, unsafe_allow_html=True)
        # === FIN GRÁFICO OEE ===
