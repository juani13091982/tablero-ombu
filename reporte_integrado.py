...
with col1:
    ...
    if not df_plot_1.empty:
        ...
        fig1, ax1 = plt.subplots(figsize=(14, 10)); ax1_line = ax1.twinx(); fig1.subplots_adjust(top=0.80, bottom=0.22, left=0.08, right=0.92); fig1.suptitle(t_enc, x=0.08, y=0.98, ha='left', fontsize=8, color='dimgray', fontweight='bold')
